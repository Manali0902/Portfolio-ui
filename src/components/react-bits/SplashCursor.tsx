...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function correctDeltaX(delta: number) { const a = canvas!.width / canvas!.height; if (a < 1) delta *= a; return delta; }
    function correctDeltaY(delta: number) { const a = canvas!.width / canvas!.height; if (a > 1) delta /= a; return delta; }
